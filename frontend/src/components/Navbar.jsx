      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center gap-1">
            <Link to="/dashboard" className="px-3 py-2 text-sm font-medium text-slate-600 hover:text-primary-600 hover:bg-primary-50 rounded-lg transition-all">
              Dashboard
            </Link>
            {isAdmin && (
              <Link to="/admin" className="px-3 py-2 text-sm font-medium text-slate-600 hover:text-primary-600 hover:bg-primary-50 rounded-lg transition-all">
                Admin Panel
              </Link>
            )}
          </div>
          ...
          <div className="flex items-center gap-3">
            ...
            <button id="logout-btn" onClick={handleLogout} className="btn-secondary btn-sm">
